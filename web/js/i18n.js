...
var I18n = (function() {
  ...
  var translations = {
    en: {
      ...
      'panel.layer_no_data': 'Data not available for this layer.',
      'panel.natural_resources': 'Natural Resources',
      'panel.geography': 'Geography',
      'panel.demographics': 'Demographics',
      'panel.political_system': 'Political System',
      'panel.governance_indicators': 'Governance Indicators',
      'panel.cultural_dimensions': 'Cultural Dimensions',
      'panel.macroeconomic_indicators': 'Macroeconomic Indicators',
      'panel.financial_system': 'Financial System',
      'panel.trade': 'Trade',
      'panel.personnel': 'Personnel',
      'panel.defense_spending': 'Defense Spending',
      'panel.capabilities': 'Capabilities',
      'panel.conflicts_incidents': 'Conflicts & Incidents',
      'panel.no_active_conflicts': 'No active conflicts',
      'panel.relation_network': 'Relation Network',
      'panel.partners': 'Partners',
      'panel.click_row_for_detail': '(click row for detail)',
      'panel.partner': 'Partner',
      'panel.type': 'Type',
      'panel.score': 'Score',
      'panel.alliance_memberships': 'Alliance Memberships',
      'panel.d3_not_loaded': 'D3.js not loaded.',
      'panel.no_relation_data': 'No relation data available.',
      'panel.bilateral_not_available': 'Detail not available for {pair}.',
      'panel.composite_indices': 'Composite Indices',
      'panel.vulnerability_risk': 'Vulnerability & Risk',
      'panel.development': 'Development',
      'panel.show_reasoning': 'Show reasoning',
      'panel.counter_arguments': 'Counter-arguments',
      'panel.analysis': 'Analysis',
      'panel.ai_generated_analysis': 'AI-Generated Analysis',
      'panel.key_developments': 'Key Developments',
      'panel.risk_factors': 'Risk Factors',
      'panel.opportunities': 'Opportunities',
      'panel.top_exports': 'Top exports',
      'panel.top_partners': 'Top partners',
      'panel.recent': 'Recent',
    ...
    it: {
      ...
      'panel.volume': 'Volume',
      'panel.loading': 'Caricamento...',
      'panel.layer_no_data': 'Dati non disponibili per questo livello.',
      'panel.natural_resources': 'Risorse Naturali',
      'panel.geography': 'Geografia',
      'panel.demographics': 'Demografia',
      'panel.political_system': 'Sistema Politico',
      'panel.governance_indicators': 'Indicatori di Governance',
      'panel.cultural_dimensions': 'Dimensioni Culturali',
      'panel.macroeconomic_indicators': 'Indicatori Macroeconomici',
      'panel.financial_system': 'Sistema Finanziario',
      'panel.trade': 'Commercio',
      'panel.personnel': 'Personale',
      'panel.defense_spending': 'Spesa per la Difesa',
      'panel.capabilities': 'Capacità',
      'panel.conflicts_incidents': 'Conflitti e Incidenti',
      'panel.no_active_conflicts': 'Nessun conflitto attivo',
      'panel.relation_network': 'Rete di Relazioni',
      'panel.partners': 'Partner',
      'panel.click_row_for_detail': '(clicca la riga per i dettagli)',
      'panel.partner': 'Partner',
      'panel.type': 'Tipo',
      'panel.score': 'Punteggio',
      'panel.alliance_memberships': 'Appartenenza ad Alleanze',
      'panel.d3_not_loaded': 'D3.js non caricato.',
      'panel.no_relation_data': 'Dati relazionali non disponibili.',
      'panel.bilateral_not_available': 'Dettaglio non disponibile per {pair}.',
      'panel.composite_indices': 'Indici Compositi',
      'panel.vulnerability_risk': 'Vulnerabilità e Rischio',
      'panel.development': 'Sviluppo',
      'panel.show_reasoning': 'Mostra ragionamento',
      'panel.counter_arguments': 'Controargomentazioni',
      'panel.analysis': 'Analisi',
      'panel.ai_generated_analysis': 'Analisi Generata dall\'IA',
      'panel.key_developments': 'Sviluppi Chiave',
      'panel.risk_factors': 'Fattori di Rischio',
      'panel.opportunities': 'Opportunità',
      'panel.top_exports': 'Principali esportazioni',
      'panel.top_partners': 'Principali partner',
