...
print_pipeline_summary() {
  ...
  echo "  Phase 3  — VALIDATE    (Agent  08)       15-20 min"
  echo "  Phase 3b — AUDIT       (Agent  17a)       2-5 min   Escalation audit"
  ...
  echo "  Phase 7  — FINALIZE    (Agent  15)        5 min"
  echo "  Phase 7b — AUDIT       (Agent  17b)       1-2 min   Quality audit"
  echo "  Phase 7c — COMMIT      (Agent  16)        5 min"
  echo ""
  echo -e "${GREEN}Autonomous audit — no human intervention required.${RESET}"
  echo ""
